...
Transformer des données en listes de composants, filtrer, calculer

**Destructuration & Spread**
Extraire des props, mettre à jour le state sans mutation

**Objets & optional chaining**
Manipuler les props, le state, les données d'API en toute sécurité

### Code lisible

**Arrow functions & template literals**
Syntaxe concise pour callbacks, event handlers, affichage dynamique

**Structures de contrôle**
Rendu conditionnel, génération de listes

### Prévention d'erreurs

**TypeScript**
Typer les props et le state, détecter les erreurs avant l'exécution

**Immutabilité (const, spread)**
Éviter les bugs liés aux mutations du state

### Travail avec l'IA

**Vocabulaire technique** → Instructions précises
**Lecture de code** → Validation et correction du code généré
