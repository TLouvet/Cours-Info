...
<QuickCheck
  question="Que se passe-t-il si vous appelez une fonction anonyme (déclarée avec const/let) avant sa déclaration ?"
  options={[
  ...
  correctAnswer={1}
  explanation="Les fonctions anonymes (déclarées avec const ou let) ne sont pas hoistées. Seules les déclarations 'function' classiques le sont. En pratique, déclarez toujours vos fonctions avant de les utiliser."
/>
