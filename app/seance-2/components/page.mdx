...
- C'est la **norme** depuis 2019

Vous ne devriez utiliser que des composants fonctionnels.
</Callout>
...
Quand vous importez un export par défaut, vous pouvez choisir le nom que vous voulez (mais gardez le même nom par convention).
...
**Composition**
- Assembler des petits composants pour en créer de plus grands
- Chaque composant a une seule responsabilité
- Réutiliser les composants partout où nécessaire

**Prop children**
- Représente le contenu entre les balises d'un composant
- Parfait pour layouts, wrappers, et UI components génériques

**Organisation**
- Un fichier par composant (nom du fichier = nom du composant)
- Dossiers séparés : components, pages, layouts

Les composants sont la base de React. Maîtriser leur création et leur composition est essentiel pour construire des applications maintenables.
</Callout>
