...
<QuickCheck
  ...
  correctAnswer={2}
  explanation="Un custom hook est une fonction JavaScript (prefixee par 'use') qui utilise des hooks React (useState, useEffect, etc.) pour extraire et reutiliser de la logique avec etat. Ce n'est pas un composant (pas de JSX retourne) ni une librairie externe."
/>
