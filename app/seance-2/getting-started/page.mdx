...
<QuickCheck
  question="Quelle est la principale différence entre React et un framework complet comme Angular ?"
  options={[
    "React est plus rapide",
    "React se concentre uniquement sur l'UI",
    "React ne peut pas faire de routing",
    "React est plus facile à apprendre"
  ]}
  correctAnswer={1}
  explanation="React est une bibliothèque qui se concentre sur l'interface utilisateur. Pour d'autres fonctionnalités (routing, gestion d'état globale, etc.), vous devez ajouter d'autres bibliothèques. C'est ce qui le distingue d'un framework complet comme Angular qui inclut tout dès le départ."
/>
...
Vite est l'outil le plus rapide pour créer un projet React.
...
<Resources resources={[
  ...
  },
  {
    ...
    description: "Documentation complète de Vite",
    url: "https://vitejs.dev",
    type: "doc"
  },
  {
    title: "React DevTools Guide",
    description: "Guide d'utilisation des React Developer Tools",
...
<QuickCheck
  question="Quel outil est recommandé pour créer un nouveau projet React en 2026 ?"
  options={[
  ...
  correctAnswer={2}
  explanation="Vite est l'outil recommandé pour créer des projets React. Create React App est obsolète et n'est plus maintenu. Vite offre des performances bien supérieures grâce à ESBuild."
/>
