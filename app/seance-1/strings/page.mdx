...
<QuickCheck
  question="Quelle est la syntaxe moderne pour insérer des variables dans une chaîne de caractères ?"
  options={[
    '"Hello " + name + "!"',
    '"Hello ${name}!"',
    '`Hello ${name}!`',
  ...
  correctAnswer={2}
  explanation="Les template literals utilisent des backticks (`) et la syntaxe ${variable} pour l'interpolation. C'est la méthode moderne et recommandée en JavaScript. Les guillemets simples ou doubles ne permettent pas l'interpolation, uniquement la concaténation avec +."
/>
